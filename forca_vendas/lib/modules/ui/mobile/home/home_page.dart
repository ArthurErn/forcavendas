...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // drawer: Drawer(
      //   backgroundColor: const Color(0xffcce8fc),
      //   child: Column(
      ...
      //           uploadDataDialog();
      //         },
      //         child: const HomeDrawerItem(
      //           text: 'Upload de dados',
      ...
      //         },
      //         child: const HomeDrawerItem(
      //             text: 'Sincronizar dados', icon: Icons.refresh),
      //       ),
      //       const SizedBox(
      //         height: 10,
      //       ),
      ...
      //           },
      //           child: const HomeDrawerItem(
      //               text: 'Consultar', icon: Icons.search)),
      //       AnimatedContainer(
      //         height: search ? 64 : 0,
      ...
      //         height: 10,
      //       ),
      //       // const HomeDrawerItem(text: 'Sobre', icon: Icons.info),
      //       const Spacer(),
      //       GestureDetector(
      //         onTap: () {
      //           exitDialog();
      //         },
      //         child: const HomeDrawerItem(
      //             text: 'Encerrar sessão', icon: Icons.exit_to_app),
      //       ),
      //       const SizedBox(
      //         height: 10,
      //       ),
