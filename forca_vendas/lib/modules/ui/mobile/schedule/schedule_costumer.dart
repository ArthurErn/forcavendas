...
int? costumerIDSchedule;
String? costumerNameSchedule;

class ScheduleCostumer extends StatefulWidget {
  final List items;
  final int index;
  const ScheduleCostumer({Key? key, required this.items, required this.index})
      : super(key: key);

  @override
  _ScheduleCostumerState createState() => _ScheduleCostumerState();
}

class _ScheduleCostumerState extends State<ScheduleCostumer> {
  @override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () {
          setState(() {
            costumerIDSchedule = widget.items[widget.index]['id'];
            costumerNameSchedule = widget.items[widget.index]['nome_razao'];
